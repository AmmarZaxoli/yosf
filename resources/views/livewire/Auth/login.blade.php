...
<head>
    ...
    <style>
        * { font-family: 'Tajawal', sans-serif; box-sizing: border-box; }
        ...
        .security-badge i { color: rgba(201,168,76,0.4); }

        /* Arabic ornament lines */
        .ornament {
            display: flex;
            align-items: center;
            gap: 0.5rem;
        ...
        .ornament-line { flex: 1; height: 1px; background: linear-gradient(90deg, transparent, rgba(201,168,76,0.3)); }
        .ornament-diamond {
                    ...
                    <div class="form-body">
                        ...
                        <form wire:submit.prevent="login">
                            ...
                            <div class="field-group">
                                ...
                                @error('name')
                                    <p class="field-error"><i class="fas fa-times-circle"></i> {{ $message }}</p>
                                @enderror
                            </div>
